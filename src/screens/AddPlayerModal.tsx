...
import { Modal, TextField, Fab, Card, Chip } from "@mui/material";
    ...
    >
      ...
      >
        ...
        <TextField
          ...
          onKeyDown={(e) => {
            if (e.key === "Enter" && playerName.trim()) handleAddPlayer();
          }}
          sx={{
        ...
        <div style={{ marginTop: 28, display: "flex", justifyContent: "flex-end", gap: 10 }}>
          <Fab
            ...
            sx={{ background: "#f5f5f5 !important", boxShadow: "none !important" }}
          >
          ...
          <Fab
            ...
            data-testid="btn-confirm-player"
            sx={{
