...
import { Fab, IconButton, ToggleButton, ToggleButtonGroup, Paper } from "@mui/material";
    ...
    <div style={{ padding: "0 16px", paddingBottom: 100 }}>
      ...
      {players.length === 0 ? (
        ...
        >
          ...
          <p style={{ color: "#888", margin: 0, fontSize: 15, lineHeight: 1.6 }}>{t("empty")}</p>
        </Paper>
      ) : (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 13, fontWeight: 700, color: side.color }}>{side.label}</span>
      </div>
    </Paper>
  );
};
